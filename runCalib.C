...
// NEW with tchain:
// ===============
const char* fileOutName = "20220415_1750_CALIB";
chain->Add("20220415_1750_0415_1900_xray_25kv_70ua_tube1.root");
...
SDD* ttt = new SDD(chain,fileOutName,"",0,0.000001); // whichdata and lumi =0 as dummy
