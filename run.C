...
// ===============
int fWhichData = 3;
const char* fileOutName = "S2He4_1";
float fLuminositypb = 1.599;
/*
const char* filecalib="foutSDD_20220510_1737_0510_1814_xray_25kV_50mA_tube1.root";
chain->Add("/media/sdddataraw/DATA/rootdata/20220510_2023_0511_0109.root");
chain->Add("/media/sdddataraw/DATA/rootdata/20220511_0118_0511_0930.root");
chain->Add("/media/sdddataraw/DATA/rootdata/20220511_0931_0511_1407.root");
chain->Add("/media/sdddataraw/DATA/rootdata/20220512_0035_0512_0923.root");
*/

const char* filecalib="foutSDD_20220414_1137_0414_1229+20220414_1603_0414_1726_xray_25kv_50+70ua_tube1.root";
chain->Add("20220526_1656_0526_1809.root");
chain->Add("20220527_0320_0527_0430.root");
...
// SDD* ttt = new SDD(filein,filecalib,fWhichData,fLuminositypb);
 SDD* ttt = new SDD(chain,fileOutName,filecalib,fWhichData,fLuminositypb);
